...
class JsonMapperServiceTest {
  ...
  @Test
  void shouldIncludeEmptyCollections() throws IOException {
  ...
  @Test
  void shouldMapBeanToJson() throws IOException {
  ...
  @Test
  void shouldMapBeanToJson2() throws IOException {
    // nullField must not be written
    // fields list must be written as a JSONArray
  ...
  @Test
  void shouldMapBeanIntervalToJson() throws IOException {
    // interval must be formated druid style
    assertEquals(JSON_BEAN_INTERVAL, mapper.toJson(beanInterval));
  }

  @Test
  void shouldMapBeanIntervalToPrettyJson() throws IOException {
  ...
  @Test
  void shouldMapJsonToBean() throws IOException {
    assertEquals(bean, mapper.fromJson(JSON_BEAN, Bean.class));
  }

  @Test
  void shouldMapJsonToBean3() throws IOException {
    assertEquals(bean, mapper.fromJson(JSON_BEAN, new TypeReference<Bean>() {}));
  }

  @Test
  void shouldThrowJsonParseException() {
    assertThrows(
  ...
  @Test
  void shouldMapJsonToBeanInstant() throws IOException {
    assertEquals(beanInstant, mapper.fromJson(JSON_BEAN_INSTANT, BeanInstant.class));
  }
  
  @Test
  void shouldMapBeanInstantToJson() throws IOException {
    assertEquals(JSON_BEAN_INSTANT, mapper.toJson(beanInstant));
  }
  
  @Test
  void shouldMapArrayToJson() throws IOException {
